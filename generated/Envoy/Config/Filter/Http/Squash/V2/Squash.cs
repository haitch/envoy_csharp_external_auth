...
namespace Envoy.Config.Filter.Http.Squash.V2 {
    ...
    static SquashReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "c3RydWN0LnByb3RvGh51ZHBhL2Fubm90YXRpb25zL21pZ3JhdGUucHJvdG8a",
            "HXVkcGEvYW5ub3RhdGlvbnMvc3RhdHVzLnByb3RvGhd2YWxpZGF0ZS92YWxp",
            "ZGF0ZS5wcm90byL+AQoGU3F1YXNoEhgKB2NsdXN0ZXIYASABKAlCB/pCBHIC",
            "IAESNAoTYXR0YWNobWVudF90ZW1wbGF0ZRgCIAEoCzIXLmdvb2dsZS5wcm90",
            "b2J1Zi5TdHJ1Y3QSMgoPcmVxdWVzdF90aW1lb3V0GAMgASgLMhkuZ29vZ2xl",
            "LnByb3RvYnVmLkR1cmF0aW9uEjUKEmF0dGFjaG1lbnRfdGltZW91dBgEIAEo",
            "CzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvbhI5ChZhdHRhY2htZW50X3Bv",
            "bGxfcGVyaW9kGAUgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uQngK",
            "MGlvLmVudm95cHJveHkuZW52b3kuY29uZmlnLmZpbHRlci5odHRwLnNxdWFz",
            "aC52MkILU3F1YXNoUHJvdG9QAfKY/o8FKRInZW52b3kuZXh0ZW5zaW9ucy5m",
            "aWx0ZXJzLmh0dHAuc3F1YXNoLnYzuoDI0QYCEAFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Envoy.Config.Filter.Http.Squash.V2.Squash), global::Envoy.Config.Filter.Http.Squash.V2.Squash.Parser, new[]{ "Cluster", "AttachmentTemplate", "RequestTimeout", "AttachmentTimeout", "AttachmentPollPeriod" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public Squash(Squash other) : this() {
      ...
      attachmentTemplate_ = other.attachmentTemplate_ != null ? other.attachmentTemplate_.Clone() : null;
      requestTimeout_ = other.requestTimeout_ != null ? other.requestTimeout_.Clone() : null;
      attachmentTimeout_ = other.attachmentTimeout_ != null ? other.attachmentTimeout_.Clone() : null;
      attachmentPollPeriod_ = other.attachmentPollPeriod_ != null ? other.attachmentPollPeriod_.Clone() : null;
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            ...
            input.ReadMessage(AttachmentTemplate);
            break;
          }
          case 26: {
            if (requestTimeout_ == null) {
          ...
          case 34: {
            ...
            input.ReadMessage(AttachmentTimeout);
            break;
          }
          case 42: {
            if (attachmentPollPeriod_ == null) {
            ...
            input.ReadMessage(AttachmentPollPeriod);
            break;
          }
        }
      }
